<?php
  ...
  if (isset($_POST['upload'])) {
    ...
    $uses = mysqli_real_escape_string($db, $_POST['uses']);
  	...
  	$sql = "INSERT INTO images (image, img_name, image_text,uses, price) VALUES ('$image', '$img_name', '$image_text','$uses', '$price')";
  	// execute query
  	mysqli_query($db, $sql);
...
<html>
  <head>
    ...
    <title>VirtualKroy || User Upload</title>
...
<body>
      ...
      <section class="product_details_area">
        ...
        echo "<img hight='100px' width= '100px' src='images/".$row['image']."' >";
        echo '</div>';
        echo '<div class="col-lg-8">';
        echo '<div class="product_details_text">';
        echo "<h3><strong>".$row['img_name']."</strong></h3>";
        echo "<p>".$row['image_text']."</p>";
        echo'<br>';
        echo "<p>".$row['uses']."</p>";
        echo "<strong>৳".$row['price']."</strong>";
        echo '<a href="orders-update.php"><button style="float:right;" class="add_cart_btn">Order</button></a>';
        echo'<br>';
        echo'<br>';
        echo "</div>";
        echo "</div>";
    ...
    <section class="track_area p_100">
      <div class="container">
        <div class="track_inner">
                <form class="track_form row" method="POST" action="user_upload.php" enctype="multipart/form-data">
                <div class="col-lg-12 form-group">
                    <label for="text">Choose your image</label>
                    <input type="hidden" name="size" value="1000000">
                    <input class="form-control" type="file" name="image">
                </div>
                <div class="col-lg-12 form-group">
                    <label for="email">Name of your product</label>
                    <input class="form-control" name="img_name" type="text" id="text">
                </div>
                <div class="col-lg-12 form-group">
                    <label for="email">Description of your product</label>
                    <input class="form-control" name="image_text" type="text" id="text">
                </div>
                <div class="col-lg-12 form-group">
                    <label for="email">If Your Product Used (e.g:month/year) </label>
                    <input class="form-control" name="uses" type="pin" id="text">
                </div>
                <div class="col-lg-12 form-group">
                    <label for="email">Price of your product</label>
                    <input class="form-control" name="price" type="pin" id="text">
                </div>
                <div class="col-lg-12 form-group">
                    <button type="submit" value="submit" name="upload" class="btn subs_btn form-control">Upload your product</button>
                </div>
                </form>
        </div>
      </div>
