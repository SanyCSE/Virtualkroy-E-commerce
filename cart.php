...
<body>
        ...
        <?php
          ...
          echo '<tr>';
          echo '<td colspan="4" align="right"><a href="update-cart.php?action=empty" class="add_cart_btn">Empty Cart</a>&nbsp;<a href="products.php" class="add_cart_btn">Continue Shopping</a>';
          if(isset($_SESSION['username'])) {
