...
<html class="no-js" lang="en">
  <head>
    ...
    <title>VirtualKroy || Register</title>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-8">
                            <div class="login_title">
                                ...
                                <p>Need an account?<br>Follow the steps below to create your account</p>
                            </div>
                            <form class="login_form row" method="POST" action="insert.php">
                                ...
                                <div class="col-lg-6 form-group">
                                    <input class="form-control" type="number" placeholder="Pin code" name="pin">
                                </div>
                                <div class="col-lg-6 form-group">
