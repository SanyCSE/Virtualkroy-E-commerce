...
<body>
    ...
    <section class="from_blog_area">
        ...
        <div class="row">
              ...
              echo '<div class="from_blog_item">';
              
              echo '<img src="img/products/' .$obj->product_img_name.'"/>';
              echo '</div>';
              echo '<div class="f_blog_text">';
    ...
    <section class="from_blog_area">
            <div class="container">
                <div class="from_blog_inner">
                    <div class="c_main_title">
                        <p><input type="submit" class="btn subs_btn form-control" value="Update Your Products"></p>
                    </div>
                </div>
            </div>
    </section>
