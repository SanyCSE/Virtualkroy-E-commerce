...
<body>
        ...
        <?php
          ...
          if(isset($_SESSION['cart'])) {
            ...
            $result = $mysqli->query("SELECT product_code, product_name, product_desc, qty, price FROM tech_products WHERE id = ".$product_id);
            ...
            if($result){
              ...
              while($obj = $result->fetch_object()) {
                ...
                echo '<td>'.$quantity.'&nbsp;<a class="button [secondary success alert]" style="padding:5px;" href="update_cart_tech.php?action=add&id='.$product_id.'">+</a>&nbsp;<a class="button alert" style="padding:5px;" href="update_cart_tech.php?action=remove&id='.$product_id.'">-</a></td>';
                echo '<td>'.$cost.'</td>';
                echo '</tr>';
              }
            }
          ...
          echo '<tr>';
          echo '<td colspan="4" align="right"><a href="update_cart_tech.php?action=empty" class="add_cart_btn">Empty Cart</a>&nbsp;<a href="products.php" class="add_cart_btn">Continue Shopping</a>';
          if(isset($_SESSION['username'])) {
            echo '<a href="orders-tech-update.php"><button style="float:right;" class="add_cart_btn">Order</button></a>';
          }

          else {
            echo '<a href="login.php"><button style="float:right;" class="add_cart_btn">Login</button></a>';
          }
          ...
          echo ' <section class="emty_cart_area p_100">
                  <div class="container">
                    <div class="emty_cart_inner">
                     <i class="icon-handbag icons"></i>
                     <h3>Your Cart is Empty</h3>
                     <h4>back to <a href="products.php">shopping</a></h4>
                    </div>
                  </div>
                 </section>';
             }
